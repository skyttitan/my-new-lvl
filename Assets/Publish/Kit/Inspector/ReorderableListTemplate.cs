...
{
	public abstract class ReorderableListTemplate : IDisposable, IList<SerializedProperty>
	{
		#region variable
			...
			bool dragable = true, bool displayHeader = true, bool displayAddButton = true, bool displayRemoveButton = true)
		{
			...
			orderList.onChangedCallback += OnChangedCallback;
		}
		#endregion
		...
		public void CopyTo(SerializedProperty[] array, int arrayIndex) { throw new NotImplementedException(); }
		...
		public void Add(SerializedProperty item) { throw new NotImplementedException(); }
