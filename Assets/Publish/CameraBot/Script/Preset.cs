...
namespace CF.CameraBot
{
    ...
    public class Preset : MonoBehaviour
    {
		...
		public void OnValidate()
		{
			...
			if (m_Host == null)
				m_Host = GetComponentInParent<CameraBot>();
		...
		public void Init()
		{
			...
			if (Instance == null)
				Instance = GetComponentInChildren<CameraStand>();
			if (Instance == null)
			{
		...
		{
#if UNITY_EDITOR
			if (Application.isPlaying && m_Host.activePreset != this)
				return;
		...
		#region API
		public Transform ChaseTarget { get { return m_Host.m_ChaseTarget; } }
		public Transform ChaseTargetRotation { get { return (m_ClampAngle.m_ForwardReference != null) ? m_ClampAngle.m_ForwardReference : (m_Host.m_TargetForward != null) ? m_Host.m_TargetForward : ChaseTarget; } }
		public Transform TargetForward { get { return m_Host.m_TargetForward; } }
		...
		public Method m_Method = new Method()
		{
			...
			m_HorizontalPositionSpeed = 8f,
			m_VerticalPositionSpeed = 8f,
