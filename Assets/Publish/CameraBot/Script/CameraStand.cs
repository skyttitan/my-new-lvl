...
#region API
		...
		internal void Init(Preset preset)
		{
			...
			m_ChaseTargetOffsetHandler.Init(preset, this, Color.white.CloneAlpha(.4f));
			
			// Yaw
			tmp = AddChild("Yaw", m_ChaseTargetOffsetHandler.transform);
			m_YawHandler = tmp.AddComponent<ArcYaw>();
			m_YawHandler.Init(preset, this, Color.red.CloneAlpha(.05f), Color.red.CloneAlpha(.5f));
			...
			m_PitchHandler.Init(preset, this, Color.blue.CloneAlpha(.05f), Color.blue.CloneAlpha(.5f));
			...
			m_CameraOffsetHandler.Init(preset, this, Color.white.CloneAlpha(.4f));
