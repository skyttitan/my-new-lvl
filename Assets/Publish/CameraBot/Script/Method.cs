...
namespace CF.CameraBot
{
    ...
    public class Method : ICloneable
    {
        ...
        [Range(0.0001f, 30f)] public float m_HorizontalPositionSpeed = 4f; // 30 fps, it's almost snap to position.
		[Range(0.0001f, 30f)] public float m_VerticalPositionSpeed = 4f; // 30 fps, it's almost snap to position.
		...
		public object Clone()
		{
			return new Method()
			{
				...
				m_HorizontalPositionSpeed = this.m_HorizontalPositionSpeed,
				m_VerticalPositionSpeed = this.m_VerticalPositionSpeed,
