...
namespace CF.CameraBot
{
    ...
    public class VirtualPointDrawer : PropertyDrawer
    {
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			line = line.GetRectBottom(height: 33f).Adjust(y: lineS);
			Rect[]
			...
			EditorGUI.LabelField(lc[0].Adjust(y: 10f, width:30f, height:20f), ArrowLeftIcon);
			...
			EditorGUI.LabelField(rc[0].Adjust(y: 10f, width: 30f, height: 20f), ArrowUpIcon);
